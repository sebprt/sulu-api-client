...
final class SuluMultipledeleteinfoAccountEndpoint
{
    public const OPERATION_ID = 'sulu-contact-multipledeleteinfo-account-get';
    ...
    public function request(array $parameters = [], array $query = [], mixed $body = null): ResponseInterface
    {
        ...
        $method = 'GET';
        $pathTmpl = '/admin/api/accounts/multipledeleteinfo.{_format}';
        $path = $pathTmpl;
